...
$(function() {
        var bookmark = {
            data: [{
                ...
                box_shadow: '#fe7700',
                icon: 'img/dongchedi.png',
            }, {
                name: '直播吧',
                link: 'https://zhibo8.cc/',
                box_shadow: '#fe7700',
                icon: 'img/zhiboba.png',
            }, {
                name: '苹果官网',
...
//导航、引擎选择器
function select() {
    $('#folder').css('display') == 'block' ? ($('#folder').css('display', 'none'), $('#nav').css('display', 'block'), document.getElementById("Select").innerHTML = "搜索引擎(点击切换书签) <img src='img/search-change.svg?v=2ae7ab8'>") : ($('#nav').css('display', 'none'), $('#folder').css('display', 'block'), document.getElementById("Select").innerHTML = "书签(点击切换搜索引擎) <img src='img/search-change.svg?v=2ae7ab8'>");
}
//导航、引擎选择器结束
